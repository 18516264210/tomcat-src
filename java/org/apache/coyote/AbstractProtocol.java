...
public abstract class AbstractProtocol<S> implements ProtocolHandler,
    ...
    public void init() throws Exception {
        ...
        try {
            ...
            // 网络 socket 处理初始化
            System.out.println("==>"+getClass()+",socket初始化");
            endpoint.init();
        } catch (Exception ex) {
    ...
    protected abstract static class AbstractConnectionHandler<S,P extends Processor<S>>
        ...
        public SocketState process(SocketWrapper<S> wrapper, SocketStatus status) {
            getLog().info("==>"+getClass()+"请求Tcp/Ip 协议转为 Http 协议的处理类");
            if (wrapper == null) {
            ...
            try {
                ...
                do {
                    if (status == SocketStatus.DISCONNECT &&
                        ...
                        getLog().info("==>processor.process1");
                        state = processor.process(wrapper);
                    }
