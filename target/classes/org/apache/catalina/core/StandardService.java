...
public class StandardService extends LifecycleMBeanBase implements Service {
    ...
    public Container getContainer() {
        System.out.println("==>"+getClass()+"，获取容器container");
    ...
    public void setContainer(Container container) {
        ...
        //IntrospectionUtils的callMethod1()方法，通过反射的形式调用setContainer方法，然后设置容器
        System.out.println("==>"+getClass()+"，设置容器container");
    ...
    protected void stopInternal() throws LifecycleException {
        ...
        synchronized (executors) {
            for (Executor executor: executors) {
                System.out.println("==>"+getClass()+",关闭线程池");
                executor.stop();
            }
        }
    }
    ...
    protected void initInternal() throws LifecycleException {
        ...
        synchronized (connectorsLock) {
            for (Connector connector : connectors) {
                try {
                    System.out.println("==>"+getClass()+"初始化connector");
                    connector.init();
                } catch (Exception e) {
