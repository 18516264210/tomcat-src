...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    public StandardServer() {
        super();
        System.out.println("==>"+getClass()+"，我是通过ObjectCreateRule类的begin方法调用的");
        ...
        if (isUseNaming()) {
            ...
            System.out.println("==>"+getClass()+",StandardServer:namingContextListener");
        ...
        synchronized (servicesLock) {
            ...
            if (getState().isAvailable()) {
                try {
                    ...
                    log.info("==>"+getClass()+",service.start()");
                    service.start();
        ...
        try {
            ...
            while (!stopAwait) {
                ...
                try {
                    ...
                    try {
                        log.info("==>"+getClass()+",serverSocket.accept()等待");
                        socket = serverSocket.accept();
                        socket.setSoTimeout(10 * 1000);  // Ten seconds
                        log.info("==>"+getClass()+"读取流信息socket.getInputStream()");
    ...
    protected void startInternal() throws LifecycleException {
        System.out.println("==>"+getClass()+",设置  state = configure_start，并通知监听listener");
        fireLifecycleEvent(CONFIGURE_START_EVENT, null);

        System.out.println("==>"+getClass()+",设置  state = start");
        ...
        synchronized (servicesLock) {
            System.out.println("==>"+getClass()+",services:"+services);
            //循环调用所有 service 的start 方法
            for (int i = 0; i < services.length; i++) {
                System.out.println("==>"+getClass()+",service[i]:"+services[i].getName()+"调用start()");
                services[i].start();
            }
        }
    }
    ...
    protected void stopInternal() throws LifecycleException {
        ...
        log.info("==>"+getClass()+",stopInternal()");
    ...
    protected void initInternal() throws LifecycleException {
        System.out.println("==>"+getClass()+",这里的方法是从LifecycleBase类的init()方法反向回调的");

        //这里又调用了LifecycleMBeanBase类的initInternal()实现，真TMCD
        System.out.println("==>"+getClass()+",StandardServer的initInternal调用LifecycleMBeanBase的initInternal()");
        super.initInternal();
        ...
        System.out.println("==>"+getClass()+",factory.setContainer("+this+")");
        ...
        //通过日志打印，可以追踪到头一次初始化是Catalina对象
        System.out.println("==>"+getClass()+",初始化service:"+services);
        for (int i = 0; i < services.length; i++) {
            System.out.println("==>"+getClass()+",initInternal:"+services[i].getName()+"初始化###");
            services[i].init();
        }
    }
