...
public abstract class AbstractHttp11Processor<S> extends AbstractProcessor<S> {
    ...
    public SocketState process(SocketWrapper<S> socketWrapper) throws IOException {
        getLog().info("==>"+getClass()+",process():"+socketWrapper);
        ...
        while (!getErrorState().isError() && keepAlive && !comet && !isAsync() &&
            ...
            if (!getErrorState().isError()) {
                ...
                try {
                    ...
                    getLog().info("==>"+getClass()+",name01:"+name);
            ...
            if (!getErrorState().isError()) {
                try {
                    ...
                    getLog().info("==>"+getClass()+",开始调用servlet处理请求");
                    Parameters parameters = request.getParameters();
                    String name = parameters.getParameter("name");
                    getLog().info("==>"+getClass()+",name02:"+name+",adapter.service(request, response);");
    ...
    protected void prepareRequest() {
        ...
        getLog().info("==>根据Request请求头prepareRequest");
        http11 = true;
        http09 = false;
        ...
        getLog().info("==>Input filter setup");
